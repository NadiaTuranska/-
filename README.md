...
- **Тип проєкту**: Вбудована система (Embedded System) / IoT-пристрій
...
| Файл | Призначення |
|------|-------------|
| `main.ino` | Основна прошивка ESP32: ініціалізація, вимірювання, збереження, передача даних |
| `Code.gs` | Google Apps Script: прийом HTTP-запитів від ESP32 та запис у Google Sheets |
...
3. Відкрийте `Розширення → Apps Script`, вставте код із `Code.gs`
...
Перед завантаженням відредагуйте змінні у `main.ino`:
